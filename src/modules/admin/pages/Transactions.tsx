...
const Transactions = () => {
  const { t } = useLanguage();
  const transactions = [
    { id: 'TXN001', customer: 'Nguyễn Văn A', venue: 'Karaoke VIP 201', type: 'booking', amount: 500000, status: 'completed', method: 'Tiền mặt', date: '2024-05-20 14:30' },
    { id: 'TXN002', customer: 'Trần Thị B', venue: 'Massage Spa 301', type: 'booking', amount: 800000, status: 'pending', method: 'Chuyển khoản', date: '2024-05-20 13:15' },
    { id: 'TXN003', customer: 'Phạm Thị D', venue: 'Club VIP Lounge', type: 'booking', amount: 2000000, status: 'completed', method: 'Ví điện tử', date: '2024-05-20 12:00' },
    { id: 'TXN004', customer: 'Nguyễn Văn A', venue: 'Karaoke VIP 201', type: 'service', amount: 500000, status: 'completed', method: 'Tiền mặt', date: '2024-05-20 11:45' },
    { id: 'TXN005', customer: 'Lê Văn C', venue: 'Massage Premium 401', type: 'refund', amount: 300000, status: 'rejected', method: 'Chuyển khoản', date: '2024-05-20 10:20' },
  ];
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {transactions.map((txn) => (
                <tr key={txn.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{txn.customer}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{txn.venue}</td>
